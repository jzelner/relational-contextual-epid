...
# Taking a spatial perspective on the `radon` data {#sec-spatial-radon}

This tutorial is a follow-up to a prior exercise using these data. So if you haven't already, please go back and take a look at the original multi-level modeling radon example in @sec-radon-multilevel.
...
For more detail on the implementation on interpretation of these models, please check out @sec-radon-multilevel.
:::
